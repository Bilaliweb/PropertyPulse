...
const ProfilePropertiesListing = ({ userProperties }) => {
        ...
        <div key={index} className="mb-10">
          ...
          <div className="mt-2">
            ...
            <p className="text-gray-600">
              Address:{" "}
              {`${property.location.street} ${property.location.state}, ${property.location.city}`}
            </p>
          </div>
          <div className="mt-2">
            <Link
...
export default ProfilePropertiesListing;