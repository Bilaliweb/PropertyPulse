...
{
  /** Navigating to route with params */
}
{
  /* <Link href={'/properties?name=test'}>Go To Properties Page</Link> */
}

{
  /** Navigating to route with params but with href having object */
}
{
  /* <Link href={{
        pathname: '/properties',
...
const NavBar = () => {
  ...
  // This state was used for intial front end implementation and session will be used for business logic
